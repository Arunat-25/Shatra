...
PvP между зарегистрированными игроками может учитываться в рейтинге (публичные комнаты всегда; в приватных — по флагу «Игра на рейтинг»). Стартовый рейтинг — **1200**. Подробности: [docs/ELO.md](docs/ELO.md).
